            ...
            <main className="sticky">
                ...
                <div className="h-screen text-white comfort mx-10 md:mx-20 my-32">
                    <div className="">
                        ...
                        <h1 className="monu text-gray-100  text-[2rem]">About</h1>
                    </div>
                    <p className="text-gray-100 flex gap-3 justify-start items-center">
                        every member has to follow these rules and regulations for better workspace 
                    </p>
                    <p>We are coding club of Shri Ram College of Engineering & Management</p>
